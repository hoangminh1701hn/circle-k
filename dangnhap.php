                ...
                <div class="content-wrapper full-page-wrapper d-flex align-items-center auth login-bg">
                        ...
                        <div class="card-body px-5 py-5">
                            ...
                            <form name="frm-login" method="post">
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-primary btn-block enter-btn"  name="user_login_btn">Đăng nhập</button>
                                </div>
                                <!-- <div class="d-flex">
                    ...
                    <button class="btn btn-google col">
                      <i class="mdi mdi-google-plus"></i> Google plus </button>
                                ...
                                <p class="sign-up" style="color:crimson;">Nếu chưa có tài khoản bạn hãy liên hệ với quản
                                    lý của bạn</p>
                            </form>
                        </div>
                    </div>
